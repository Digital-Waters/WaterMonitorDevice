...
def testCameraSettings():
    ...
    for exposure_time in exposure_times:
        for analogue_gain in analogue_gains:
            ...
            image_filename = f"image_{timestamp}_ET{exposure_time}_AG{analogue_gain}.jpg"
            image_path = os.path.join(imageFolder, image_filename)
            picam2.capture_file(image_path)
            print(f"Captured image with ExposureTime={exposure_time}, AnalogueGain={analogue_gain}")
